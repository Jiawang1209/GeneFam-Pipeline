...
Commit:
- hash: 2dbc20d
- message: test: require result-statement figure readings
- files: publication audit, figure interpretation templates, objective audit, docs, tests, history
...
Commit:
- hash: f4e5dc8de36655a29f2fc5386314c3f362626c68
- message: test: add R runtime health gate
- files: R runtime health check script, release-check gate, tests, release/quickstart/readiness docs, README, and history entry.
...
Commit:
- hash: a8b16b569ad587f8049083457191a53bb947a2f6
- message: test: require delivery manifest handoff items
...
Commit:
- hash: 03be47a6e24c682409feba3510674f387e472bec
