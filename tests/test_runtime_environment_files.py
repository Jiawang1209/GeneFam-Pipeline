...
def test_readme_points_to_final_handoff_report():
    ...
    assert "plot_png_path" in readme
    assert "PDF and PNG plot targets" in readme
    assert "per-figure close-reading anchors" in readme
    ...
    assert "figure_interpretation_qc_specificity" in readme
    assert "figure-specific QC warnings" in readme
