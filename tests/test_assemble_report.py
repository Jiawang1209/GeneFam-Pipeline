...
def test_assemble_report_renders_output_availability_and_wgd_sections():
    ...
    figure_interpretations = [
        {
            ...
            "key_observations": "Expansion and contraction contrasts are visible across species.",
            ...
            "result_reading_status": "figure-specific close reading; QC-table evidence is covered before manuscript use",
    ...
    assert "- Result reading status: figure-specific close reading; QC-table evidence is covered before manuscript use" in report
...
def test_assemble_report_cli_writes_markdown(tmp_path):
    ...
    assert "- Result reading status: figure-specific close reading" in text
