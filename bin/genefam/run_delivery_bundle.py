...
def build_delivery_manifest(
    ...
    rows = [
        ...
        },
        {
            ...
            "note": "paper-style report closure: valid plot file signatures, complete per-figure close-reading text, QC tables and warnings, software/R package versions, per-figure method/software version coverage, and reproducibility commands",
        },
        {
            "section": "status",
            ...
            "note": "WGD report closure: valid plot file signatures, complete Ka/Ks/WGD figure close-reading text, gamma beta alpha theta interpretation, QC tables and warnings, software/R package versions, per-figure method/software version coverage, and reproducibility commands",
        },
        {
            "section": "input",
