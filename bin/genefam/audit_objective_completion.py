...
def build_objective_audit(
    ...
    rows = [
        ...
        _achieved_if(
            ...
            "The delivery figure gallery is audited by figure_gallery_audit so each row links plot files to interpretation, software versions, final report anchors, and the traceability matrix with valid gallery plot file signatures. "
