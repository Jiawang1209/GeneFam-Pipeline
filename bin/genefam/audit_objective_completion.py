...
def build_objective_audit(
    ...
    rows = [
        ...
        _achieved_if(
            ...
            "gene family information visualization smoke, feature summary visualization smoke, promoter cis-element visualization smoke, tree feature visualization smoke, MCScanX circlize visualization smoke, Nextflow standard visualization smoke, PPI ggNetView plot smoke, standard branch expression smoke, and expression heatmap visualization smoke",
