...
TEMPLATES = {
    ...
    "mcscanx": (
        "MCScanX self intra-species collinearity overview",
        "MCScanX self pair table and chromosome coordinates",
        "within-species MCScanX self links among family members and their chromosome positions.",
        "Dense intra-species link clusters, skipped links, and chromosome-specific concentrations of duplicated genes define the self-collinearity structure visible in the plot.",
        "Within-species MCScanX self structure supports tandem or segmental/WGD-derived relationships when paired with Ks evidence.",
    ),
    "kaks": (
...
QC_TABLES = {
    ...
    "duplicate_type_kaks": "tables/duplicate_type_kaks.tsv; tables/duplicate_type_kaks_summary.tsv; tables/duplicate_type_kaks_skipped.tsv; tables/mcscanx_duplicate_types.tsv",
...
METHOD_AND_SOFTWARE = {
    ...
    "duplicate_type_kaks": "MCScanX self duplicate classes; build_mcscanx_duplicate_types.py; build_duplicate_type_kaks.py; plot_duplicate_type_kaks.R; /usr/local/bin/R; GeneFamilyFlow",
