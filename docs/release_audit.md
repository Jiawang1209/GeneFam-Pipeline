...
| gamma beta alpha theta interpretation | `configs/wgd_events.brassicaceae.yaml`; `docs/wgd_event_evidence.md`; `docs/duplication_retention_design.md`; WGD event names must be unique in the event YAML | `python -m pytest tests/test_build_wgd_event_evidence.py -q` |
