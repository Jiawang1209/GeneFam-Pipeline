...
| standard identification branch | `workflows/main.nf`; `workflows/modules/identification_inputs.nf`; `workflows/modules/standard_postprocess.nf`; `bin/genefam/build_identification_inputs.py`; `bin/genefam/extract_family_sequences.py`; `bin/genefam/build_standard_report_index.py`; `bin/genefam/assemble_report.py`; `bin/genefam/run_standard_smoke.py`; `bin/genefam/concat_tsv.py`; `results/standard_smoke/report/final_report.md` | `python -m pytest tests/test_build_identification_inputs.py tests/test_concat_tsv.py tests/test_extract_family_sequences.py tests/test_standard_branch_report_index.py tests/test_assemble_report.py tests/test_run_standard_smoke.py tests/test_workflow_modules.py -q` |
