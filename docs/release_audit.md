...
| final report | `bin/genefam/assemble_report.py`; `bin/genefam/build_figure_interpretations.py`; `bin/genefam/audit_publication_report.py`; `workflows/modules/report.nf`; `workflows/modules/standard_postprocess.nf`; `results/mock_mvp/report/final_report.md`; `results/nextflow_standard_feature_smoke/standard/report/final_report.md`; `results/nextflow_standard_feature_smoke/standard/report/figure_interpretations.tsv`; `results/nextflow_standard_feature_smoke/standard/report/software_versions.tsv`; `results/publication_report_audit/publication_report_audit.md` | `python -m pytest tests/test_assemble_report.py tests/test_build_figure_interpretations.py tests/test_audit_publication_report.py tests/test_run_mock_mvp.py -q` |
