...
The file uses placeholder data paths such as `data/species_bank`, `data/reference/GDSL_reference.pep.fa`, and `data/expression/family_expression.tsv`. Replace these with project-specific files before real execution.
