...
- `standard_report_index_audit`: standard report-index closure at `results/report_index_audit/standard_report_index_audit.md`, covering indexed plot manifests, software versions, `figure_interpretations.tsv`, `figure_interpretations.md`, `final_report.md`, `figure_traceability_matrix`, and all available indexed report paths exist
- `wgd_report_index_audit`: WGD report-index closure at `results/report_index_audit/wgd_report_index_audit.md`, covering indexed plot manifests, software versions, `figure_interpretations.tsv`, `figure_interpretations.md`, `final_report.md`, `figure_traceability_matrix`, and all available indexed report paths exist
